 ...
 */
package com.empresa.classes.graficos;
...
public class GUI extends javax.swing.JFrame {
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        if (sinal.equals("soma")) {
            double somar = valor01 + valor02;
            txtResultado.setText(String.valueOf(somar));
        }
        else if (sinal.equals("multiplicacao")) {
            valor02 = Double.parseDouble(txtResultado.getText());
            double multiplicacao = valor01 * valor02;
            txtResultado.setText(String.valueOf(multiplicacao));
        }
